...
public class OptionValueController {
  ...
  @GetMapping
  public ResponseEntity<ResponseData<OptionValueResponse>> getOptionValues(
    ...
    var responses = optionValueService.getAllOptionValues(pageable);
  ...
  public ResponseEntity<OptionValueResponse> createOptionValue(
    ...
    var response = optionValueService.saveOptionValue(request);
    return new ResponseEntity<>(response, HttpStatus.CREATED);
  }

  @PutMapping("/{id}")
  public ResponseEntity<OptionValueResponse> updateOptionValue(
      @PathVariable long id, @RequestBody OptionValueRequest request) {
    var response = optionValueService.updateOptionValue(id, request);
